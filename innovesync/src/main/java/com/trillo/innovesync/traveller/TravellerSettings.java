...
/**
 * Embedded settings document for traveller notification, privacy, and defaults.
 */
public class TravellerSettings {

    private boolean emailAlertsEnabled;
    private boolean smsAlertsEnabled;
    private boolean pushNotificationsEnabled;
    private String digestCadence; // e.g. Daily, Weekly

    private String profileVisibility; // e.g. Travellers only, Public
    ...
    public static TravellerSettings defaultSettings() {
    ...
    public TravellerSettings copy() {
        TravellerSettings copy = new TravellerSettings();
